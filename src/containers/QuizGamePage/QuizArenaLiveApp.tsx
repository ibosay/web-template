...
export const QUESTIONS: Question[] = [
  ...
  { id: 331, category: 'Islam', question: "Wie viele anerkannte sunnitische Rechtsschulen werden heute gewöhnlich genannt?", answers: ["Zwei","Drei","Vier","Sechs"], correct: 2, source: "Oxford Bibliographies; SeekersGuidance, Four Sunni schools" },
  { id: 332, category: 'Islam', question: "Nach welchem Imam ist die hanafitische Rechtsschule benannt?", answers: ["Abu Hanifa","Malik ibn Anas","Al Shafiʿi","Ahmad ibn Hanbal"], correct: 0, source: "Oxford Bibliographies, The Hanafi School" },
  { id: 333, category: 'Islam', question: "Mit welcher Stadt ist Imam Abu Hanifas frühe Lehrtätigkeit besonders verbunden?", answers: ["Kufa","Medina","Damaskus","Kairo"], correct: 0, source: "Oxford Bibliographies, The Hanafi School; Encyclopaedia Iranica, Hanafite Madhhab" },
  { id: 334, category: 'Islam', question: "Welcher Gelehrte war ein bedeutender Schüler Imam Abu Hanifas?", answers: ["Abu Yusuf","Imam al Bukhari","Imam an Nawawi","Ibn Hajar"], correct: 0, source: "Oxford Bibliographies, The Hanafi School" },
  { id: 335, category: 'Islam', question: "Welcher juristische Begriff wird besonders mit der hanafitischen Methodik verbunden?", answers: ["Istihsan","Tawaf","Suhur","Adhan"], correct: 0, source: "Oxford Bibliographies, The Hanafi School" },
  { id: 336, category: 'Islam', question: "Nach welchem Imam ist die malikitische Rechtsschule benannt?", answers: ["Malik ibn Anas","Abu Hanifa","Ahmad ibn Hanbal","Al Shafiʿi"], correct: 0, source: "Store norske leksikon, Maliki school; Malik ibn Anas" },
  { id: 337, category: 'Islam', question: "In welcher Stadt lebte und lehrte Imam Malik besonders?", answers: ["Medina","Kufa","Bagdad","Cordoba"], correct: 0, source: "Store norske leksikon, Maliki school" },
  { id: 338, category: 'Islam', question: "Wie heißt das bekannte Werk von Imam Malik?", answers: ["Al Muwatta","Sahih Muslim","Al Umm","Musnad Ahmad"], correct: 0, source: "Malik ibn Anas; Maliki school references" },
  { id: 339, category: 'Islam', question: "Welcher Praxis misst die malikitische Rechtstradition besondere Bedeutung bei?", answers: ["Der Praxis der Gelehrten und Gemeinschaft von Medina","Der römischen Rechtspraxis","Nur lokalen Handelsbräuchen Europas","Ausschließlich später Philosophie"], correct: 0, source: "Store norske leksikon, Maliki school" },
  { id: 340, category: 'Islam', question: "Nach welchem Imam ist die schafiitische Rechtsschule benannt?", answers: ["Muhammad ibn Idris al Shafiʿi","Malik ibn Anas","Abu Yusuf","Ahmad ibn Hanbal"], correct: 0, source: "Shafi'i school overview" },
  { id: 341, category: 'Islam', question: "Welche vier sunnitischen Rechtsschulen sind in der Ahl as Sunna anerkannt?", answers: ["Hanafi, Maliki, Schafiʿi und Hanbali","Hanafi, Maliki, Schafiʿi und Zahiri","Maliki, Hanbali, Awzai und Zahiri","Hanafi, Thawri, Awzai und Zahiri"], correct: 0, source: "Sunnitische Fiqh Tradition, vier Madhahib" },
  { id: 342, category: 'Islam', question: "Nach welchem Imam ist die hanbalitische Rechtsschule benannt?", answers: ["Ahmad ibn Hanbal","Abu Hanifa","Malik ibn Anas","Al Shafiʿi"], correct: 0, source: "Encyclopaedia Iranica, Hanbalite Madhhab" },
  { id: 343, category: 'Islam', question: "In welcher Stadt entwickelte sich die hanbalitische Rechtsschule besonders früh?", answers: ["Bagdad","Mekka","Kufa","Granada"], correct: 0, source: "Encyclopaedia Iranica, Hanbalite Madhhab" },
  { id: 344, category: 'Islam', question: "Welche sunnitische Rechtsschule ist nach Imam Ahmad ibn Hanbal benannt?", answers: ["Hanbali","Hanafi","Maliki","Schafiʿi"], correct: 0, source: "Sunnitische Fiqh Tradition, vier Madhahib" },
  { id: 345, category: 'Islam', question: "Welche sunnitische Rechtsschule ist nach Imam Malik ibn Anas benannt?", answers: ["Maliki","Hanafi","Schafiʿi","Hanbali"], correct: 0, source: "Sunnitische Fiqh Tradition, vier Madhahib" },
  { id: 346, category: 'Islam', question: "Wann beginnt nach der bekannten Position Imam Abu Hanifas die Asr Zeit im Vergleich zu den anderen drei Imamen?", answers: ["Wenn der Schatten eines Gegenstands etwa doppelt so lang ist wie der Gegenstand, zusätzlich zum Mittagsschatten","Direkt nach Fajr","Erst nach Maghrib","Immer genau um 15 Uhr"], correct: 0, source: "SeekersGuidance, Why Does the Hanafi School Differ regarding the Prayer Times?" },
  { id: 347, category: 'Islam', question: "Welche drei Imame werden bei der bekannten früheren Asr Zeit gemeinsam genannt?", answers: ["Malik, al Shafiʿi und Ahmad ibn Hanbal","Abu Hanifa, al Bukhari und Muslim","Malik, Abu Yusuf und Ibn Taymiyya","Al Shafiʿi, an Nawawi und al Bukhari"], correct: 0, source: "SeekersGuidance, Why Does the Hanafi School Differ regarding the Prayer Times?" },
  ...
  { id: 349, category: 'Islam', question: "Welches Werk Imam al Shafiʿis ist besonders mit seiner Rechtsmethodik verbunden?", answers: ["Al Risala","Al Muwatta","Sahih Muslim","Musnad Ahmad"], correct: 0, source: "Cambridge University Press, The Canonization of Islamic Law" },
...
export const HARD_QUESTION_IDS = new Set([22,25,26,27,37,42,46,48,51,52,53,54,57,58,59,63,65,68,69,70,72,73,77,80,83,86,87,88,113,115,121,126,127,128,133,134,135,136,137,140,141,142,143,144,145,146,147,148,149,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,227,228,229,230,231,232,233,234,235,236,237,238,239,240,241,242,243,244,245,246,247,248,249,250,331,332,333,334,335,336,337,338,339,340,341,342,343,344,345,346,347,348,349,350,352,353,354,358,360]);

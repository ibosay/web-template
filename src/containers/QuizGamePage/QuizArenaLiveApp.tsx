...
export const QUESTIONS: Question[] = [
  ...
  { id: 401, category: 'Staatsbürgerschaft Österreich', question: 'Zu welchem großen Reich gehörte das Gebiet des heutigen Österreich ab dem Jahre Null fast 500 Jahre lang?', answers: ['Zum Römischen Reich','Zum Osmanischen Reich','Zum Deutschen Bund','Zum Byzantinischen Reich'], correct: 0, source: 'Geschichte Österreichs, 10-001' },
  { id: 402, category: 'Staatsbürgerschaft Österreich', question: 'Wo lag das größte Konzentrationslager auf dem Gebiet des heutigen Österreich?', answers: ['Dachau','Mauthausen','Auschwitz','Buchenwald'], correct: 1, source: 'Geschichte Österreichs, 10-006' },
  { id: 403, category: 'Staatsbürgerschaft Österreich', question: 'Welches wichtige Ereignis geschah in Österreich 1955?', answers: ['Österreich trat der EU bei','Die Republik wurde erstmals ausgerufen','Der Staatsvertrag wurde unterzeichnet','Das Frauenwahlrecht wurde eingeführt'], correct: 2, source: 'Geschichte Österreichs, 10-008' },
  { id: 404, category: 'Staatsbürgerschaft Österreich', question: 'Welcher Fluss bildete in der Römerzeit eine wichtige Grenze des Römischen Reiches?', answers: ['Der Rhein','Die Elbe','Die Mur','Die Donau'], correct: 3, source: 'Geschichte Österreichs, 10-012' },
  { id: 405, category: 'Staatsbürgerschaft Österreich', question: 'Welche heutige österreichische Stadt hat mit Vindobona einen Ursprung in der Römerzeit?', answers: ['Wien','Graz','Innsbruck','Klagenfurt'], correct: 0, source: 'Geschichte Österreichs, 10-015' },
  { id: 406, category: 'Staatsbürgerschaft Österreich', question: 'Welche Familie begann ab 1273 lange Zeit über Österreich zu herrschen?', answers: ['Die Bourbonen','Die Habsburger','Die Hohenzollern','Die Medici'], correct: 1, source: 'Geschichte Österreichs, 10-017' },
  { id: 407, category: 'Staatsbürgerschaft Österreich', question: 'Zu welchem Reich gehörte Österreich bis zum Beginn des 19. Jahrhunderts?', answers: ['Zum Osmanischen Reich','Zum Russischen Reich','Zum Heiligen Römischen Reich','Zum Britischen Empire'], correct: 2, source: 'Geschichte Österreichs, 10-018' },
  { id: 408, category: 'Staatsbürgerschaft Österreich', question: 'In welchem Jahr wurde das Kaiserreich Österreich gegründet?', answers: ['1789','1815','1867','1804'], correct: 3, source: 'Geschichte Österreichs, 10-019' },
  { id: 409, category: 'Staatsbürgerschaft Österreich', question: 'Wer galt im 18. Jahrhundert als die große Reformerin Österreichs?', answers: ['Maria Theresia','Elisabeth von Österreich','Maria Anna','Zita von Bourbon-Parma'], correct: 0, source: 'Geschichte Österreichs, 10-020' },
  { id: 410, category: 'Staatsbürgerschaft Österreich', question: 'Wie hieß Österreich in der ältesten genannten Urkunde?', answers: ['Vindobona','Ostarrîchi','Austria-Hungaria','Norikum'], correct: 1, source: 'Geschichte Österreichs, 10-026' },
  { id: 411, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde die Zweite Türkenbelagerung Wiens abgewehrt?', answers: ['1529','1740','1683','1815'], correct: 2, source: 'Geschichte Österreichs, 10-027' },
  { id: 412, category: 'Staatsbürgerschaft Österreich', question: 'Wie hieß die Zusammenkunft der Monarchen 1814 und 1815 in Wien?', answers: ['Prager Kongress','Berliner Kongress','Salzburger Kongress','Wiener Kongress'], correct: 3, source: 'Geschichte Österreichs, 10-029' },
  { id: 413, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde das Frauenwahlrecht in Österreich eingeführt?', answers: ['1918','1907','1920','1945'], correct: 0, source: 'Geschichte Österreichs, 10-032' },
  { id: 414, category: 'Staatsbürgerschaft Österreich', question: 'Welches Ereignis war der Auslöser des Ersten Weltkrieges?', answers: ['Die Unterzeichnung des Staatsvertrags','Die Ermordung Franz Ferdinands in Sarajevo','Die Gründung der UNO','Die Zweite Türkenbelagerung'], correct: 1, source: 'Geschichte Österreichs, 10-033' },
  { id: 415, category: 'Staatsbürgerschaft Österreich', question: 'Welche Staatsform erhielt Österreich 1918?', answers: ['Absolute Monarchie','Militärdiktatur','Republik','Königreich'], correct: 2, source: 'Geschichte Österreichs, 10-035' },
  { id: 416, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde die wiedererlangte Unabhängigkeit Österreichs erklärt?', answers: ['15. Mai 1955','26. Oktober 1955','12. November 1918','27. April 1945'], correct: 3, source: 'Geschichte Österreichs, 10-039' },
  { id: 417, category: 'Staatsbürgerschaft Österreich', question: 'Welche vier Staaten waren nach dem Zweiten Weltkrieg Besatzungsmächte in Österreich?', answers: ['USA, Sowjetunion, Großbritannien und Frankreich','USA, Italien, Spanien und Frankreich','Deutschland, Italien, Japan und Ungarn','Kanada, Australien, Indien und Frankreich'], correct: 0, source: 'Geschichte Österreichs, 10-040' },
  { id: 418, category: 'Staatsbürgerschaft Österreich', question: 'Wer war der erste Bundespräsident der Zweiten Republik?', answers: ['Theodor Körner','Karl Renner','Leopold Figl','Adolf Schärf'], correct: 1, source: 'Geschichte Österreichs, 10-041' },
  { id: 419, category: 'Staatsbürgerschaft Österreich', question: 'Wer war der erste Bundeskanzler der Zweiten Republik?', answers: ['Karl Renner','Julius Raab','Leopold Figl','Theodor Körner'], correct: 2, source: 'Geschichte Österreichs, 10-042' },
  { id: 420, category: 'Staatsbürgerschaft Österreich', question: 'Seit wann ist Österreich Mitglied der UNO?', answers: ['Seit 1945','Seit 1960','Seit 1995','Seit 1955'], correct: 3, source: 'Geschichte Österreichs, 10-046' },
  { id: 421, category: 'Staatsbürgerschaft Österreich', question: 'Wie wurde das US-Hilfsprogramm zum Wiederaufbau Europas ab 1947 genannt?', answers: ['Marshallplan','Schumanplan','Dawesplan','Monnetplan'], correct: 0, source: 'Geschichte Österreichs, 10-047' },
  { id: 422, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde der österreichische Staatsvertrag unterzeichnet?', answers: ['26. Oktober 1955','15. Mai 1955','27. April 1945','1. Jänner 1995'], correct: 1, source: 'Geschichte Österreichs, 10-052' },
  { id: 423, category: 'Staatsbürgerschaft Österreich', question: 'Wo wurde der österreichische Staatsvertrag unterzeichnet?', answers: ['In der Hofburg','Im Parlament','Im Schloss Belvedere in Wien','Im Schloss Schönbrunn'], correct: 2, source: 'Geschichte Österreichs, 10-053' },
  { id: 424, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde die immerwährende Neutralität Österreichs erklärt?', answers: ['15. Mai 1955','8. Mai 1945','1. Jänner 1995','26. Oktober 1955'], correct: 3, source: 'Geschichte Österreichs, 10-055' },
  { id: 425, category: 'Staatsbürgerschaft Österreich', question: 'Wann trat Österreich der Europäischen Union bei?', answers: ['1. Jänner 1995','1. Jänner 1990','26. Oktober 1955','1. Mai 2004'], correct: 0, source: 'Geschichte Österreichs, 10-057' },
  { id: 426, category: 'Staatsbürgerschaft Österreich', question: 'Welches Wirtschaftssystem hat Österreich laut dem Fragenkatalog?', answers: ['Planwirtschaft','Soziale Marktwirtschaft','Reine Zentralverwaltungswirtschaft','Feudalwirtschaft'], correct: 1, source: 'Geschichte Österreichs, 10-058' },
  { id: 427, category: 'Staatsbürgerschaft Österreich', question: 'Wann entstand die Doppelmonarchie Österreich-Ungarn?', answers: ['1804','1848','1867','1918'], correct: 2, source: 'Geschichte Österreichs, 10-064' },
  { id: 428, category: 'Staatsbürgerschaft Österreich', question: 'Wann endete die Monarchie in Österreich?', answers: ['1867','1938','1945','1918'], correct: 3, source: 'Geschichte Österreichs, 10-068' },
  { id: 429, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde die Republik Österreich 1918 ausgerufen?', answers: ['12. November 1918','28. Juni 1914','27. April 1945','15. Mai 1955'], correct: 0, source: 'Geschichte Österreichs, 10-074' },
  { id: 430, category: 'Staatsbürgerschaft Österreich', question: 'In welchem Jahr wurde der Name Österreich laut dem Fragenkatalog erstmals in einer Urkunde verwendet?', answers: ['1156','996','1273','1453'], correct: 1, source: 'Geschichte Österreichs, 10-097' },
  { id: 431, category: 'Staatsbürgerschaft Österreich', question: 'Welcher heutige Staat gehörte im Laufe der Geschichte zeitweise zum Kaiserreich Österreich?', answers: ['Spanien','Tschechien','Portugal','Schweden'], correct: 1, source: 'Geschichte Österreichs, 10-002' },
  { id: 432, category: 'Staatsbürgerschaft Österreich', question: 'Welche Forderungen gehörten wesentlich zur Revolution von 1848 im Kaiserreich Österreich?', answers: ['Eine Verfassung, ein Parlament und Grundrechte','Die Abschaffung aller Schulen','Die Einführung einer Militärdiktatur','Die Auflösung aller Städte'], correct: 0, source: 'Geschichte Österreichs, 10-003' },
  { id: 433, category: 'Staatsbürgerschaft Österreich', question: 'Welche Religion war 1918 in Österreich-Ungarn offiziell anerkannt?', answers: ['Keine Religion','Nur die römisch-katholische Religion','Unter anderem die islamische Religion','Nur die jüdische Religion'], correct: 2, source: 'Geschichte Österreichs, 10-004' },
  { id: 434, category: 'Staatsbürgerschaft Österreich', question: 'Welche Folge hatte der Erste Weltkrieg für Österreich?', answers: ['Österreich gewann neue Kolonien','Österreich-Ungarn zerfiel und Österreich erlitt Gebietsverluste','Die Monarchie wurde vergrößert','Österreich trat 1918 der EU bei'], correct: 1, source: 'Geschichte Österreichs, 10-005' },
  { id: 435, category: 'Staatsbürgerschaft Österreich', question: 'Wer wurde nach dem Anschluss Österreichs an Hitler-Deutschland verfolgt?', answers: ['Nur ausländische Soldaten','Vor allem Jüdinnen und Juden, Roma und Sinti, politische Gegner und weitere verfolgte Gruppen','Nur Beamte','Nur Menschen aus Wien'], correct: 1, source: 'Geschichte Österreichs, 10-007' },
  { id: 436, category: 'Staatsbürgerschaft Österreich', question: 'Welche Reform gehörte zu den wichtigen Reformen Österreichs in den 1970er Jahren?', answers: ['Die Ehe- und Familienrechtsreform','Die Wiedereinführung der Monarchie','Die Abschaffung der Universitäten','Die Auflösung des Parlaments'], correct: 0, source: 'Geschichte Österreichs, 10-009' },
  { id: 437, category: 'Staatsbürgerschaft Österreich', question: 'Welche EU-Entscheidung beeinflusste den Alltag der Menschen in Österreich?', answers: ['Die Einführung des Euro','Die Abschaffung aller nationalen Gesetze','Die Einführung einer EU-Armee als Pflicht','Die Auflösung der Gemeinden'], correct: 0, source: 'Geschichte Österreichs, 10-010' },
  { id: 438, category: 'Staatsbürgerschaft Österreich', question: 'Wodurch endete die Römerzeit auf dem Gebiet des heutigen Österreich?', answers: ['Durch die Industrialisierung','Durch die Völkerwanderung und den Zusammenbruch der römischen Herrschaft im 5. Jahrhundert','Durch den Wiener Kongress','Durch den EU-Beitritt'], correct: 1, source: 'Geschichte Österreichs, 10-011' },
  { id: 439, category: 'Staatsbürgerschaft Österreich', question: 'Wie lange dauerte die Römerzeit auf dem Gebiet des heutigen Österreich ungefähr?', answers: ['Etwa 50 Jahre','Etwa 100 Jahre','Etwa 500 Jahre','Etwa 1000 Jahre'], correct: 2, source: 'Geschichte Österreichs, 10-013' },
  { id: 440, category: 'Staatsbürgerschaft Österreich', question: 'Welche Siedler kamen nach der Römerzeit unter anderem ins Land?', answers: ['Awaren, Slawen, Bajuwaren und Alamannen','Nur Römer und Griechen','Spanier und Portugiesen','Nur Franken und Briten'], correct: 0, source: 'Geschichte Österreichs, 10-014' },
  { id: 441, category: 'Staatsbürgerschaft Österreich', question: 'Warum wurde Deutsch zur vorwiegenden Sprache in Österreich?', answers: ['Vor allem durch frühmittelalterliche Besiedlung sowie deutsche Verwaltungs- und Schulsprache','Weil Latein im 20. Jahrhundert verboten wurde','Nur durch den EU-Beitritt','Nur durch den Buchdruck'], correct: 0, source: 'Geschichte Österreichs, 10-016' },
  { id: 442, category: 'Staatsbürgerschaft Österreich', question: 'Was wurde unter Maria Theresia aufgebaut oder reformiert?', answers: ['Eine zentrale Staatsverwaltung und ein allgemeines Schulwesen','Eine demokratische Republik','Die Europäische Union','Die UNO'], correct: 0, source: 'Geschichte Österreichs, 10-021' },
  { id: 443, category: 'Staatsbürgerschaft Österreich', question: 'Was gehörte zur industriellen Revolution?', answers: ['Maschinen, Fabriken, Dampfkraft und Eisenbahnen','Nur Landwirtschaft ohne Maschinen','Die Abschaffung aller Städte','Die Rückkehr zur Leibeigenschaft'], correct: 0, source: 'Geschichte Österreichs, 10-022' },
  { id: 444, category: 'Staatsbürgerschaft Österreich', question: 'Was bedeutet Absolutismus?', answers: ['Eine Herrschaftsform mit unbeschränkter Macht des Monarchen ohne wirksame Kontrolle','Eine direkte Demokratie ohne Regierung','Eine Wirtschaftsordnung ohne Staat','Eine föderale Republik'], correct: 0, source: 'Geschichte Österreichs, 10-023' },
  { id: 445, category: 'Staatsbürgerschaft Österreich', question: 'War die Revolution von 1848 in Österreich dauerhaft erfolgreich?', answers: ['Ja, sie führte sofort zu einer stabilen Demokratie','Nein, sie wurde langfristig niedergeschlagen, obwohl sie kurzfristig Zugeständnisse erzwang','Ja, sie beendete 1848 die Monarchie endgültig','Nein, weil es überhaupt keine Reformen gab'], correct: 1, source: 'Geschichte Österreichs, 10-024' },
  { id: 446, category: 'Staatsbürgerschaft Österreich', question: 'Welche wichtige Reform blieb nach der Revolution von 1848 bestehen?', answers: ['Die Aufhebung der Leibeigenschaft und die Grundentlastung','Die Einführung des Euro','Die Gründung der NATO','Die Abschaffung der Schulen'], correct: 0, source: 'Geschichte Österreichs, 10-025' },
  { id: 447, category: 'Staatsbürgerschaft Österreich', question: 'Wie hieß die einzige Frau an der Spitze der habsburgischen Herrschaft?', answers: ['Maria Theresia','Kaiserin Zita','Elisabeth von Österreich','Maria Anna'], correct: 0, source: 'Geschichte Österreichs, 10-028' },
  { id: 448, category: 'Staatsbürgerschaft Österreich', question: 'Was war ein Ergebnis des Wiener Kongresses 1814 und 1815?', answers: ['Europa wurde neu geordnet und ein Mächtegleichgewicht angestrebt','Die Europäische Union wurde gegründet','Österreich wurde Republik','Die UNO wurde gegründet'], correct: 0, source: 'Geschichte Österreichs, 10-030' },
  { id: 449, category: 'Staatsbürgerschaft Österreich', question: 'Wann wurde in Österreich das allgemeine Männerwahlrecht eingeführt?', answers: ['1848','1867','1907','1918'], correct: 2, source: 'Geschichte Österreichs, 10-031' },
  { id: 450, category: 'Staatsbürgerschaft Österreich', question: 'Welche Regierungsform hatte Österreich bis 1918?', answers: ['Eine Monarchie','Eine Bundesrepublik','Eine Militärdiktatur','Eine Räterepublik'], correct: 0, source: 'Geschichte Österreichs, 10-034' },
  { id: 451, category: 'Staatsbürgerschaft Österreich', question: 'Welches Gebiet musste Österreich 1919 unter anderem an Italien abtreten?', answers: ['Südtirol','Vorarlberg','Wien','Burgenland'], correct: 0, source: 'Geschichte Österreichs, 10-036' },
  { id: 452, category: 'Staatsbürgerschaft Österreich', question: 'Was versteht man unter dem Anschluss Österreichs am 12. März 1938?', answers: ['Die gewaltsame Annexion Österreichs durch das nationalsozialistische Deutsche Reich','Den Beitritt Österreichs zur EU','Den Staatsvertrag von 1955','Die Gründung Österreich-Ungarns'], correct: 0, source: 'Geschichte Österreichs, 10-037' },
  { id: 453, category: 'Staatsbürgerschaft Österreich', question: 'Welches Ereignis löste am 1. September 1939 den Zweiten Weltkrieg aus?', answers: ['Der Überfall Deutschlands auf Polen','Der Wiener Kongress','Der Staatsvertrag','Die Gründung der UNO'], correct: 0, source: 'Geschichte Österreichs, 10-038' },
  { id: 454, category: 'Staatsbürgerschaft Österreich', question: 'Woran erkennt man UNO-Soldaten häufig?', answers: ['An blauen Helmen oder blauen Baretten','An roten Uniformen ohne Abzeichen','An grünen Helmen mit EU-Sternen','An schwarzen Baretten ohne Emblem'], correct: 0, source: 'Geschichte Österreichs, 10-043' },
  { id: 455, category: 'Staatsbürgerschaft Österreich', question: 'Wo befindet sich der Hauptsitz der UNO?', answers: ['Genf','New York','Wien','Brüssel'], correct: 1, source: 'Geschichte Österreichs, 10-044' },
  { id: 456, category: 'Staatsbürgerschaft Österreich', question: 'Was ist ein vorrangiges Ziel der UNO?', answers: ['Die Sicherung des Weltfriedens und die Förderung internationaler Zusammenarbeit','Die Einführung einer Weltwährung','Die Abschaffung aller Staaten','Die Gründung einer europäischen Monarchie'], correct: 0, source: 'Geschichte Österreichs, 10-045' },
  { id: 457, category: 'Staatsbürgerschaft Österreich', question: 'Wie heißt der 1949 gegründete militärische Zusammenschluss westlicher Staaten?', answers: ['NATO','EFTA','UNO','Warschauer Pakt'], correct: 0, source: 'Geschichte Österreichs, 10-048' },
  { id: 458, category: 'Staatsbürgerschaft Österreich', question: 'Wie hieß der 1955 gegründete militärische Zusammenschluss osteuropäischer Staaten?', answers: ['NATO','Warschauer Pakt','EFTA','UNO'], correct: 1, source: 'Geschichte Österreichs, 10-049' },
  { id: 459, category: 'Staatsbürgerschaft Österreich', question: 'Wie wird die Europäische Freihandelsassoziation abgekürzt?', answers: ['UNO','NATO','EFTA','EURO'], correct: 2, source: 'Geschichte Österreichs, 10-050' },
  { id: 460, category: 'Staatsbürgerschaft Österreich', question: 'Wer war der erste vom Volk gewählte Bundespräsident der Zweiten Republik?', answers: ['Karl Renner','Theodor Körner','Leopold Figl','Julius Raab'], correct: 1, source: 'Geschichte Österreichs, 10-051' },
  { id: 461, category: 'Staatsbürgerschaft Österreich', question: 'Wer war bei der Unterzeichnung des Staatsvertrages 1955 österreichischer Außenminister?', answers: ['Leopold Figl','Karl Renner','Theodor Körner','Bruno Kreisky'], correct: 0, source: 'Geschichte Österreichs, 10-054' },
  { id: 462, category: 'Staatsbürgerschaft Österreich', question: 'Was fand 1978 zum bereits gebauten Atomkraftwerk Zwentendorf statt?', answers: ['Eine Volksabstimmung gegen die Inbetriebnahme','Eine Krönung','Ein EU-Referendum','Die Unterzeichnung des Staatsvertrages'], correct: 0, source: 'Geschichte Österreichs, 10-056' },
  { id: 463, category: 'Staatsbürgerschaft Österreich', question: 'Welche Institution ist ein österreichischer Sozialpartner?', answers: ['Arbeiterkammer','Verfassungsgerichtshof','Bundesheer','Nationalbank'], correct: 0, source: 'Geschichte Österreichs, 10-059' },
  { id: 464, category: 'Staatsbürgerschaft Österreich', question: 'Was ist das Kyoto-Protokoll?', answers: ['Ein internationales Abkommen zum Klimaschutz','Ein österreichisches Wahlgesetz','Ein militärischer Bündnisvertrag','Ein Handelsvertrag aus dem 19. Jahrhundert'], correct: 0, source: 'Geschichte Österreichs, 10-060' },
  { id: 465, category: 'Staatsbürgerschaft Österreich', question: 'Was ist das Budget eines Staates?', answers: ['Der Finanzplan mit Einnahmen und Ausgaben für einen bestimmten Zeitraum','Nur die Summe der Steuern','Nur die Staatsschulden','Eine Liste aller Gesetze'], correct: 0, source: 'Geschichte Österreichs, 10-061' },
  { id: 466, category: 'Staatsbürgerschaft Österreich', question: 'Welche Gruppe zählt zu den anerkannten Minderheiten in Österreich?', answers: ['Kroaten','Kanadier','Spanier','Dänen'], correct: 0, source: 'Geschichte Österreichs, 10-062' },
  { id: 467, category: 'Staatsbürgerschaft Österreich', question: 'Welche Aufzählung enthält nur anerkannte autochthone Volksgruppen in Österreich?', answers: ['Kroaten, Slowenen, Ungarn, Tschechen, Slowaken und Roma','Franzosen, Spanier, Portugiesen und Dänen','Schweden, Norweger und Finnen','Belgier, Niederländer und Luxemburger'], correct: 0, source: 'Geschichte Österreichs, 10-063' },
  { id: 468, category: 'Staatsbürgerschaft Österreich', question: 'Wie wird die erste eigene Verfassung Österreichs bezeichnet?', answers: ['Dezemberverfassung von 1867','Maiverfassung von 1955','Oktoberverfassung von 1918','Jännerverfassung von 1995'], correct: 0, source: 'Geschichte Österreichs, 10-065' },
  { id: 469, category: 'Staatsbürgerschaft Österreich', question: 'Wer war 1867 Kaiser von Österreich und König von Ungarn?', answers: ['Franz Joseph I.','Karl I.','Leopold I.','Joseph II.'], correct: 0, source: 'Geschichte Österreichs, 10-066' },
  { id: 470, category: 'Staatsbürgerschaft Österreich', question: 'Warum wurde Österreich-Ungarn als Vielvölker-Staat bezeichnet?', answers: ['Weil viele verschiedene Volksgruppen, Sprachen, Kulturen und Religionen im Reich lebten','Weil nur eine Sprache erlaubt war','Weil es keine Grenzen gab','Weil alle Einwohner dieselbe Religion hatten'], correct: 0, source: 'Geschichte Österreichs, 10-067' },
  { id: 471, category: 'Staatsbürgerschaft Österreich', question: 'Wer wurde 1918 der erste Staatskanzler der Republik Österreich?', answers: ['Karl Renner','Leopold Figl','Theodor Körner','Julius Raab'], correct: 0, source: 'Geschichte Österreichs, 10-069' },
  { id: 472, category: 'Staatsbürgerschaft Österreich', question: 'Welche Krise gehörte zur Entwicklung der Ersten Republik?', answers: ['Inflation, Arbeitslosigkeit und politische Gewalt','Ein Wirtschaftsboom ohne Arbeitslosigkeit','Die Gründung der EU','Die Einführung des Euro'], correct: 0, source: 'Geschichte Österreichs, 10-070' },
  { id: 473, category: 'Staatsbürgerschaft Österreich', question: 'Wann dauerte der Erste Weltkrieg?', answers: ['1905 bis 1909','1914 bis 1918','1939 bis 1945','1945 bis 1955'], correct: 1, source: 'Geschichte Österreichs, 10-071' },
  { id: 474, category: 'Staatsbürgerschaft Österreich', question: 'Mit welchen Staaten war Österreich-Ungarn im Ersten Weltkrieg vor allem verbündet?', answers: ['Deutsches Reich, Osmanisches Reich und Bulgarien','Frankreich, Großbritannien und Russland','USA, Kanada und Australien','Spanien, Portugal und Schweiz'], correct: 0, source: 'Geschichte Österreichs, 10-072' },
  { id: 475, category: 'Staatsbürgerschaft Österreich', question: 'Welcher Staat entstand beziehungsweise wurde nach dem Zerfall Österreich-Ungarns neu gegründet oder wiederhergestellt?', answers: ['Tschechoslowakei','Belgien','Spanien','Norwegen'], correct: 0, source: 'Geschichte Österreichs, 10-073' },
  { id: 476, category: 'Staatsbürgerschaft Österreich', question: 'Was wurde im Vertrag von Saint-Germain unter anderem festgelegt?', answers: ['Gebietsabtretungen und ein Anschlussverbot an Deutschland','Der EU-Beitritt Österreichs','Die Einführung des Euro','Die Gründung der UNO'], correct: 0, source: 'Geschichte Österreichs, 10-075' },
  { id: 477, category: 'Staatsbürgerschaft Österreich', question: 'Seit wann ist Österreich ein Bundesstaat?', answers: ['Seit 1867','Seit 1918','Seit 1920','Seit 1955'], correct: 2, source: 'Geschichte Österreichs, 10-076' },
  { id: 478, category: 'Staatsbürgerschaft Österreich', question: 'Welche Entwicklung gehörte zu den Krisen nach der Gründung der Republik Österreich?', answers: ['Wirtschaftliche Not, politische Gewalt und Autoritarismus','Eine sofortige stabile Vollbeschäftigung','Die Gründung der NATO in Wien','Die Abschaffung aller Parteien 1919'], correct: 0, source: 'Geschichte Österreichs, 10-077' },
  { id: 479, category: 'Staatsbürgerschaft Österreich', question: 'Wann ist eine Regierung autoritär?', answers: ['Wenn sie Macht stark konzentriert, Opposition einschränkt und Grundrechte beschneidet','Wenn Parlamente frei kontrollieren können','Wenn Grundrechte besonders geschützt werden','Wenn alle Entscheidungen direkt abgestimmt werden'], correct: 0, source: 'Geschichte Österreichs, 10-078' },
  { id: 480, category: 'Staatsbürgerschaft Österreich', question: 'Welches Ereignis fand im Februar 1934 in Österreich statt?', answers: ['Die Februarkämpfe beziehungsweise der österreichische Bürgerkrieg','Der EU-Beitritt','Die Unterzeichnung des Staatsvertrages','Die Gründung Österreich-Ungarns'], correct: 0, source: 'Geschichte Österreichs, 10-079' },
  { id: 481, category: 'Staatsbürgerschaft Österreich', question: 'Was bedeutet Inflation?', answers: ['Ein anhaltender Anstieg der Preise und ein Verlust der Kaufkraft des Geldes','Ein dauerhafter Rückgang aller Preise','Die Abschaffung von Geld','Die Einführung einer neuen Staatsform'], correct: 0, source: 'Geschichte Österreichs, 10-080' },
  { id: 482, category: 'Staatsbürgerschaft Österreich', question: 'Was ist ein Putsch?', answers: ['Die illegale, meist gewaltsame Ergreifung der Macht','Eine reguläre Parlamentswahl','Ein Volksbegehren','Eine internationale Konferenz'], correct: 0, source: 'Geschichte Österreichs, 10-081' },
  { id: 483, category: 'Staatsbürgerschaft Österreich', question: 'Was geschah beim NS-Putschversuch im Juli 1934?', answers: ['Bundeskanzler Engelbert Dollfuß wurde ermordet, der Putsch scheiterte jedoch','Der Putsch führte zum EU-Beitritt','Der Staatsvertrag wurde unterzeichnet','Österreich wurde 1934 Mitglied der UNO'], correct: 0, source: 'Geschichte Österreichs, 10-082' },
  { id: 484, category: 'Staatsbürgerschaft Österreich', question: 'Warum waren viele Menschen nach der Gründung der Ersten Republik unzufrieden?', answers: ['Wegen Gebietsverlusten, wirtschaftlicher Krise, Arbeitslosigkeit und Inflation','Weil Österreich neue Kolonien erhalten hatte','Weil es keine wirtschaftlichen Probleme gab','Weil die EU gegründet wurde'], correct: 0, source: 'Geschichte Österreichs, 10-083' },
  { id: 485, category: 'Staatsbürgerschaft Österreich', question: 'Welche Folge hatte die Unzufriedenheit in der Ersten Republik?', answers: ['Politische Radikalisierung und Gewalt sowie später Autoritarismus','Eine sofortige jahrzehntelange politische Stabilität','Die Einführung des Euro','Die Gründung der UNO'], correct: 0, source: 'Geschichte Österreichs, 10-084' },
  { id: 486, category: 'Staatsbürgerschaft Österreich', question: 'Was erhofften sich viele Österreicher vom Anschluss 1938?', answers: ['Wirtschaftliche Verbesserung, Arbeitsplätze und Wohlstand','Den sofortigen Beitritt zur UNO','Die Einführung des Euro','Die Rückkehr zur römischen Herrschaft'], correct: 0, source: 'Geschichte Österreichs, 10-085' },
  { id: 487, category: 'Staatsbürgerschaft Österreich', question: 'Wozu kam es nach dem Anschluss Österreichs 1938?', answers: ['Zur nationalsozialistischen Terrorherrschaft, Verfolgung und zum Verlust demokratischer Freiheiten','Zu einer sofortigen demokratischen Stabilisierung','Zum Beitritt Österreichs zur EU','Zur Gründung der Zweiten Republik'], correct: 0, source: 'Geschichte Österreichs, 10-086' },
  { id: 488, category: 'Staatsbürgerschaft Österreich', question: 'Welche Aussage über Österreich in den Jahren 1938 bis 1945 entspricht dem Fragenkatalog?', answers: ['Österreich war Teil des Deutschen Reiches, viele Menschen wurden verfolgt und viele Österreicher beteiligten sich auch an Verbrechen','Alle Österreicher waren Gegner des NS-Regimes','In Österreich gab es keine Verfolgung','Österreich war in dieser Zeit unabhängig'], correct: 0, source: 'Geschichte Österreichs, 10-087' },
  { id: 489, category: 'Staatsbürgerschaft Österreich', question: 'Von wem stammte laut dem Fragenkatalog die Melodie zur österreichischen Bundeshymne der Zweiten Republik?', answers: ['Joseph Haydn','Wolfgang Amadeus Mozart','Johann Strauss','Franz Schubert'], correct: 0, source: 'Geschichte Österreichs, 10-088' },
  { id: 490, category: 'Staatsbürgerschaft Österreich', question: 'Wann endete der Zweite Weltkrieg in Europa?', answers: ['8. Mai 1945','1. September 1939','15. Mai 1955','26. Oktober 1955'], correct: 0, source: 'Geschichte Österreichs, 10-089' },
  { id: 491, category: 'Staatsbürgerschaft Österreich', question: 'Wer gehörte zu den wichtigsten Siegermächten des Zweiten Weltkrieges?', answers: ['USA, Sowjetunion, Großbritannien und Frankreich','Deutschland, Italien und Japan','Spanien, Portugal und Schweiz','Österreich, Ungarn und Bulgarien'], correct: 0, source: 'Geschichte Österreichs, 10-090' },
  { id: 492, category: 'Staatsbürgerschaft Österreich', question: 'Welche Aussage zur Zeit nach dem Zweiten Weltkrieg entspricht dem Fragenkatalog?', answers: ['Österreich war von 1945 bis 1955 von vier Alliierten besetzt','Österreich war ab 1945 sofort EU-Mitglied','Die Besatzung endete 1946','Österreich blieb bis 1970 besetzt'], correct: 0, source: 'Geschichte Österreichs, 10-091' },
  { id: 493, category: 'Staatsbürgerschaft Österreich', question: 'Wodurch halfen die USA besonders beim Wiederaufbau Österreichs nach dem Zweiten Weltkrieg?', answers: ['Durch den Marshallplan','Durch den Warschauer Pakt','Durch die EFTA','Durch den Wiener Kongress'], correct: 0, source: 'Geschichte Österreichs, 10-092' },
  { id: 494, category: 'Staatsbürgerschaft Österreich', question: 'Bis wann dauerte die Besatzungszeit in Österreich nach dem Zweiten Weltkrieg?', answers: ['Bis 1948','Bis 1950','Bis 1955','Bis 1965'], correct: 2, source: 'Geschichte Österreichs, 10-093' },
  { id: 495, category: 'Staatsbürgerschaft Österreich', question: 'Welche Verpflichtung musste Österreich 1955 unter anderem akzeptieren?', answers: ['Das Anschlussverbot an Deutschland','Den Beitritt zum Warschauer Pakt','Die Abschaffung der Minderheitenrechte','Die Aufgabe der Unabhängigkeit'], correct: 0, source: 'Geschichte Österreichs, 10-094' },
  { id: 496, category: 'Staatsbürgerschaft Österreich', question: 'Was trug nach der Gründung der Zweiten Republik zu einer neuen österreichischen Identität bei?', answers: ['Demokratische Ordnung, Staatsvertrag, Neutralität und soziale Marktwirtschaft','Die Wiedererrichtung der Monarchie','Die Abschaffung des Parlaments','Die Rückkehr zum Absolutismus'], correct: 0, source: 'Geschichte Österreichs, 10-095' },
  { id: 497, category: 'Staatsbürgerschaft Österreich', question: 'Wodurch wurde Österreich 1453 vom Herzogtum zum Erzherzogtum erhoben?', answers: ['Durch das Privilegium maius','Durch den Staatsvertrag','Durch den Vertrag von Saint-Germain','Durch den Wiener Kongress'], correct: 0, source: 'Geschichte Österreichs, 10-096' },

  { id: 498, category: 'Staatsbürgerschaft Wien', question: 'Wo entstand das historische Wien?', answers: ['Innere Stadt, 1. Bezirk','Favoriten, 10. Bezirk','Donaustadt, 22. Bezirk','Hietzing, 13. Bezirk'], correct: 0, source: 'Wien, 39-001' },
  { id: 499, category: 'Staatsbürgerschaft Wien', question: 'Die ersten Siedlungen Wiens gehen auf die römische Antike zurück. Wie hieß das im 1. Jahrhundert n. Chr. angelegte römische Militärlager?', answers: ['Vindobona','Carnuntum','Noricum','Vindonissa'], correct: 0, source: 'Wien, 39-002' },
  { id: 500, category: 'Staatsbürgerschaft Wien', question: 'Woran erinnert die berühmte Einkaufsstraße mit dem Namen „Graben“ im 1. Wiener Gemeindebezirk?', answers: ['An einen ehemaligen Stadtgraben','An einen römischen Tempel','An einen alten Donauhafen','An einen mittelalterlichen Markt'], correct: 0, source: 'Wien, 39-003' },
  { id: 501, category: 'Staatsbürgerschaft Wien', question: 'Wann wurde das Stadtrecht von Wien in einer Urkunde erstmals schriftlich festgelegt?', answers: ['1221','1156','1273','1365'], correct: 0, source: 'Wien, 39-004' },
  { id: 502, category: 'Staatsbürgerschaft Wien', question: 'Über welches Gebiet erstreckte sich die Stadt Wien vor 1850?', answers: ['Auf das Gebiet des heutigen 1. Bezirks','Auf die heutigen Bezirke 1 bis 9','Auf das gesamte heutige Stadtgebiet','Nur auf den heutigen 2. Bezirk'], correct: 0, source: 'Wien, 39-005' },
  { id: 503, category: 'Staatsbürgerschaft Wien', question: 'Wie heißt der erste Bezirk?', answers: ['Innere Stadt','Leopoldstadt','Landstraße','Wieden'], correct: 0, source: 'Wien, 39-006' },
  { id: 504, category: 'Staatsbürgerschaft Wien', question: 'Welcher Fluss gab der Stadt Wien ihren Namen?', answers: ['Der Wienfluss','Die Donau','Der Donaukanal','Die Liesing'], correct: 0, source: 'Wien, 39-007' },
  { id: 505, category: 'Staatsbürgerschaft Wien', question: 'Welche Teile Wiens gehören zum Weltkulturerbe?', answers: ['Wiener Innenstadt und Schloss Schönbrunn','Prater und Donauinsel','Belvedere und Rathaus','Stephansdom und UNO-City'], correct: 0, source: 'Wien, 39-008' },
  { id: 506, category: 'Staatsbürgerschaft Wien', question: 'Wie heißt das heute noch bestehende Krankenhaus, das 1784 in Wien gegründet wurde und in dem auch arme Personen behandelt wurden?', answers: ['Allgemeines Krankenhaus der Stadt Wien, AKH','Klinik Favoriten','Hanusch-Krankenhaus','Klinik Hietzing'], correct: 0, source: 'Wien, 39-009' },
  { id: 507, category: 'Staatsbürgerschaft Wien', question: 'Wo können Mütter in Notsituationen neugeborene Babys anonym abgeben?', answers: ['In Babyklappen','Nur im Rathaus','Nur bei der Polizei','Nur in Apotheken'], correct: 0, source: 'Wien, 39-010' },
  { id: 508, category: 'Staatsbürgerschaft Wien', question: 'Welcher Brunnen erinnert noch heute an die Eröffnung der 1. Hochquellenwasserleitung?', answers: ['Hochstrahlbrunnen','Donnerbrunnen','Vermählungsbrunnen','Neptunbrunnen'], correct: 0, source: 'Wien, 39-011' },
  { id: 509, category: 'Staatsbürgerschaft Wien', question: 'Wie wird Wien mit Wasser versorgt?', answers: ['Über zwei Hochquellenwasserleitungen','Nur aus der Donau','Nur aus Grundwasserbrunnen im Stadtgebiet','Über eine Meerwasserentsalzungsanlage'], correct: 0, source: 'Wien, 39-012' },
  { id: 510, category: 'Staatsbürgerschaft Wien', question: 'Wie heißen die Wohnungen, die von der Stadt Wien gebaut wurden und von Wiener Wohnen vermietet werden?', answers: ['Gemeindewohnungen','Bundeswohnungen','Landeswohnungen','Bezirkswohnungen'], correct: 0, source: 'Wien, 39-013' },
  { id: 511, category: 'Staatsbürgerschaft Wien', question: 'Was war das Besondere an den Gemeindewohnungen, die in der Zwischenkriegszeit errichtet wurden?', answers: ['Fortschrittliche Architektur, moderne Ausstattung und Gemeinschaftseinrichtungen','Nur besonders große Wohnungen','Ausschließlich private Gärten','Keine gemeinschaftlichen Einrichtungen'], correct: 0, source: 'Wien, 39-014' },
  { id: 512, category: 'Staatsbürgerschaft Wien', question: 'Wie viele Wohnungen wurden von 1920 bis 1934 von der Stadt Wien gebaut?', answers: ['Rund 60.000 Wohnungen','Rund 6.000 Wohnungen','Rund 30.000 Wohnungen','Rund 120.000 Wohnungen'], correct: 0, source: 'Wien, 39-015' },
  { id: 513, category: 'Staatsbürgerschaft Wien', question: 'Woher kommt der Begriff Gemeindewohnung?', answers: ['Aus der Zeit des Roten Wiens','Aus der Römerzeit','Aus der Zeit Maria Theresias','Aus der Besatzungszeit'], correct: 0, source: 'Wien, 39-016' },
  { id: 514, category: 'Staatsbürgerschaft Wien', question: 'Was meint man, wenn man vom „Roten Wien“ spricht?', answers: ['Die Zeit von 1919 bis 1934 mit sozialdemokratischer Stadtregierung','Die Zeit der Monarchie bis 1918','Die Besatzungszeit 1945 bis 1955','Die Zeit seit dem EU-Beitritt'], correct: 0, source: 'Wien, 39-017' },
  { id: 515, category: 'Staatsbürgerschaft Wien', question: 'Was ist das Besondere an Wien?', answers: ['Kaiserliche Residenzstadt, UNO-Sitz, Kultur und hohe Lebensqualität','Nur die Lage an der Donau','Nur der Flughafen','Nur die U-Bahn'], correct: 0, source: 'Wien, 39-018' },
  { id: 516, category: 'Staatsbürgerschaft Wien', question: 'Was ist der Wiener Bürgermeister gleichzeitig noch?', answers: ['Vorsitzender des Gemeinderates und Landtages sowie Stadtoberhaupt','Nur Bezirksvorsteher des 1. Bezirks','Bundespräsident','Präsident des Nationalrates'], correct: 0, source: 'Wien, 39-019' },
  { id: 517, category: 'Staatsbürgerschaft Wien', question: 'Wo hat der Wiener Bürgermeister seit 1883 seinen Amtssitz?', answers: ['Im Wiener Rathaus','In der Hofburg','Im Schloss Schönbrunn','Im Parlament'], correct: 0, source: 'Wien, 39-020' },
  { id: 518, category: 'Staatsbürgerschaft Wien', question: 'Wie heißt der amtierende Wiener Bürgermeister?', answers: ['Michael Ludwig','Alexander Van der Bellen','Karl Nehammer','Michael Häupl'], correct: 0, source: 'Wien, 39-021' },
  { id: 519, category: 'Staatsbürgerschaft Wien', question: 'Aus wie vielen Gemeinderätinnen und Gemeinderäten besteht der Wiener Gemeinderat?', answers: ['100','80','120','183'], correct: 0, source: 'Wien, 39-022' },
  { id: 520, category: 'Staatsbürgerschaft Wien', question: 'Wer darf an den Sitzungen beim Wiener Gemeinderat zusehen und zuhören?', answers: ['Bürgerinnen und Bürger, weil die Sitzungen grundsätzlich öffentlich sind','Nur Gemeinderatsmitglieder','Nur Journalistinnen und Journalisten','Nur Beschäftigte der Stadt Wien'], correct: 0, source: 'Wien, 39-023' },
  { id: 521, category: 'Staatsbürgerschaft Wien', question: 'Welche politischen Parteien sind derzeit im Wiener Gemeinderat vertreten?', answers: ['SPÖ, ÖVP, FPÖ, Die Grünen und NEOS','SPÖ, ÖVP und KPÖ','ÖVP, FPÖ und BZÖ','SPÖ, Grüne und Liste Pilz'], correct: 0, source: 'Wien, 39-024' },
  { id: 522, category: 'Staatsbürgerschaft Wien', question: 'Aus wie vielen Bezirken besteht Wien seit 1954?', answers: ['23 Bezirke','21 Bezirke','22 Bezirke','24 Bezirke'], correct: 0, source: 'Wien, 39-025' },
  { id: 523, category: 'Staatsbürgerschaft Wien', question: 'Wie heißt die größte Glocke des Stephansdoms, die immer zu Beginn des Neuen Jahres (Silvester) geläutet wird?', answers: ['Pummerin','Liesl','Maria','Steffl'], correct: 0, source: 'Wien, 39-026' },
  { id: 524, category: 'Staatsbürgerschaft Wien', question: 'Wie wird der Stephansdom von den Wienern und Wienerinnen noch genannt?', answers: ['Steffl','Pummerin','Rathausmann','Riesenrad'], correct: 0, source: 'Wien, 39-027' },
  { id: 525, category: 'Staatsbürgerschaft Wien', question: 'Wo steht der Stephansdom?', answers: ['Am Stephansplatz','Am Karlsplatz','Am Rathausplatz','Am Schwarzenbergplatz'], correct: 0, source: 'Wien, 39-028' },
  { id: 526, category: 'Staatsbürgerschaft Wien', question: 'Welche war die erste U-Bahn Linie in Wien?', answers: ['U1','U2','U4','U6'], correct: 0, source: 'Wien, 39-029' },
  { id: 527, category: 'Staatsbürgerschaft Wien', question: 'Wie viele U-Bahn Linien gibt es in Wien?', answers: ['Fünf','Vier','Sechs','Sieben'], correct: 0, source: 'Wien, 39-030' },
  { id: 528, category: 'Staatsbürgerschaft Wien', question: 'Bis zu welcher Altersgrenze dürfen Schülerinnen und Schüler auch in den Schulferien kostenlos die öffentlichen Verkehrsmittel in Wien benutzen?', answers: ['Bis zum vollendeten 15. Lebensjahr','Bis zum vollendeten 12. Lebensjahr','Bis zum vollendeten 16. Lebensjahr','Bis zum vollendeten 18. Lebensjahr'], correct: 0, source: 'Wien, 39-031' },
  { id: 529, category: 'Staatsbürgerschaft Wien', question: 'In welchem bedeutenden Gebäude in Wien wurde 1955 der Staatsvertrag unterzeichnet?', answers: ['Im Schloss Belvedere','In der Hofburg','Im Schloss Schönbrunn','Im Wiener Rathaus'], correct: 0, source: 'Wien, 39-032' },
  { id: 530, category: 'Staatsbürgerschaft Wien', question: '1945-1955: Von welcher der 4 alliierten Mächte wurde der erste Wiener Bezirk verwaltet?', answers: ['Von allen vier alliierten Mächten gemeinsam','Nur von den USA','Nur von der Sowjetunion','Nur von Großbritannien'], correct: 0, source: 'Wien, 39-033' },
  { id: 531, category: 'Staatsbürgerschaft Wien', question: 'In welchem Bezirk befindet sich das Schloss Belvedere, wo der Staatsvertrag unterzeichnet wurde?', answers: ['Im 3. Bezirk, Landstraße','Im 1. Bezirk, Innere Stadt','Im 13. Bezirk, Hietzing','Im 22. Bezirk, Donaustadt'], correct: 0, source: 'Wien, 39-034' },
  { id: 532, category: 'Staatsbürgerschaft Wien', question: 'In welchem Wiener Schloss wurde 1955 der Österreichische Staatsvertrag unterzeichnet?', answers: ['Im Schloss Belvedere','Im Schloss Schönbrunn','In der Hofburg','Im Parlament'], correct: 0, source: 'Wien, 39-035' },
  { id: 533, category: 'Staatsbürgerschaft Wien', question: 'Was befindet sich heute im Schloss Belvedere?', answers: ['Die Österreichische Galerie Belvedere','Das Parlament','Die UNO-City','Das Wiener Rathaus'], correct: 0, source: 'Wien, 39-036' },
  { id: 534, category: 'Staatsbürgerschaft Wien', question: 'Was bedeutet die Abkürzung OSZE?', answers: ['Organisation für Sicherheit und Zusammenarbeit in Europa','Organisation für soziale Zusammenarbeit in Europa','Österreichischer Sicherheits- und Zivilschutz-Einsatz','Organisation für Staaten und Zentraleuropa'], correct: 0, source: 'Wien, 39-037' },
  { id: 535, category: 'Staatsbürgerschaft Wien', question: 'Was ist das Ziel der OSZE?', answers: ['Sicherheit und Zusammenarbeit in Europa sowie Frieden, Demokratie und Menschenrechte','Eine gemeinsame europäische Währung','Nur militärische Verteidigung','Die Verwaltung der EU'], correct: 0, source: 'Wien, 39-038' },
  { id: 536, category: 'Staatsbürgerschaft Wien', question: 'Welche Rolle spielt Wien für die UNO?', answers: ['Wien ist einer der vier Amtssitze der UNO','Wien ist der einzige UNO-Sitz','Wien hat keinen UNO-Sitz','Wien ist nur ein EU-Sitz'], correct: 0, source: 'Wien, 39-039' },
  { id: 537, category: 'Staatsbürgerschaft Wien', question: 'In welchem Bezirk befindet sich die UNO-City?', answers: ['Im 22. Bezirk, Donaustadt','Im 1. Bezirk, Innere Stadt','Im 3. Bezirk, Landstraße','Im 10. Bezirk, Favoriten'], correct: 0, source: 'Wien, 39-040' },
  { id: 538, category: 'Staatsbürgerschaft Wien', question: 'Wo wohnte Erzherzogin Maria Theresia im Sommer?', answers: ['Im Schloss Schönbrunn','Im Schloss Belvedere','In der Hofburg','Im Schloss Laxenburg'], correct: 0, source: 'Wien, 39-041' },
  { id: 539, category: 'Staatsbürgerschaft Wien', question: 'Woher kommt der Name des Schlosses Schönbrunn?', answers: ['Von einem „schönen Brunnen“','Von Kaiserin Elisabeth','Von einem Baumeister namens Schön','Von der Lage am Wienfluss'], correct: 0, source: 'Wien, 39-042' },
  { id: 540, category: 'Staatsbürgerschaft Wien', question: 'Was befindet sich in Schönbrunn?', answers: ['Gloriette, Tiergarten, Gärten und Brunnen','UNO-City und Rathaus','Prater und Riesenrad','Parlament und Hofburg'], correct: 0, source: 'Wien, 39-043' },
  { id: 541, category: 'Staatsbürgerschaft Wien', question: 'Was befindet sich zwischen dem Naturhistorischen und dem Kunsthistorischen Museum?', answers: ['Maria-Theresien-Platz','Heldenplatz','Karlsplatz','Schwarzenbergplatz'], correct: 0, source: 'Wien, 39-044' },
  { id: 542, category: 'Staatsbürgerschaft Wien', question: 'Was ist der Prater?', answers: ['Ein großes Erholungs- und Vergnügungsgebiet im 2. Bezirk','Ein Schloss im 13. Bezirk','Ein Regierungsgebäude im 1. Bezirk','Ein See im 22. Bezirk'], correct: 0, source: 'Wien, 39-045' },
  { id: 543, category: 'Staatsbürgerschaft Wien', question: 'Welches Wahrzeichen befindet sich im Prater?', answers: ['Das Riesenrad','Der Donauturm','Die Pummerin','Der Rathausmann'], correct: 0, source: 'Wien, 39-046' },
  { id: 544, category: 'Staatsbürgerschaft Wien', question: 'Wie heißt der Teil des Praters, der ein Vergnügungspark ist?', answers: ['Wurstelprater','Volksprater','Kaiserprater','Donauprater'], correct: 0, source: 'Wien, 39-047' },
  { id: 545, category: 'Staatsbürgerschaft Wien', question: 'Wozu wurde die Donauinsel ursprünglich errichtet?', answers: ['Als Teil eines Hochwasserschutzprojekts','Für den Bau eines Flughafens','Als neue Autobahntrasse','Als ausschließliches Naturschutzgebiet'], correct: 0, source: 'Wien, 39-048' },
  { id: 546, category: 'Staatsbürgerschaft Wien', question: 'Woran erinnert das Zeichen „05“ am Wiener Stephansdom?', answers: ['An den österreichischen Widerstand gegen das NS-Regime','An die Eröffnung des Stephansdoms','An die Revolution von 1848','An den Staatsvertrag von 1955'], correct: 0, source: 'Wien, 39-049' },
  { id: 547, category: 'Staatsbürgerschaft Wien', question: 'Wie viele Einwohner hat Wien derzeit?', answers: ['Mehr als zwei Millionen Einwohner','Rund 500.000 Einwohner','Rund eine Million Einwohner','Rund drei Millionen Einwohner'], correct: 0, source: 'Wien, 39-050' },
  { id: 548, category: 'Staatsbürgerschaft Wien', question: 'Wie viele Gemeindewohnungen gibt es derzeit?', answers: ['Rund 220.000 Gemeindewohnungen','Rund 22.000','Rund 60.000','Rund 500.000'], correct: 0, source: 'Wien, 39-051' },
  { id: 549, category: 'Staatsbürgerschaft Wien', question: 'Welche Periode nennt man die Zeit des „Ständestaates“?', answers: ['1934 bis 1938','1919 bis 1934','1938 bis 1945','1945 bis 1955'], correct: 0, source: 'Wien, 39-052' },
  { id: 550, category: 'Staatsbürgerschaft Wien', question: 'Wen nannte man „die Vier im Jeep“?', answers: ['Vier alliierte Besatzungssoldaten','Vier Wiener Bürgermeister','Vier österreichische Bundeskanzler','Vier UNO-Generalsekretäre'], correct: 0, source: 'Wien, 39-053' },
  { id: 551, category: 'Staatsbürgerschaft Wien', question: 'Welche Ämter übt die Wiener Bürgermeisterin bzw. der Wiener Bürgermeister aus?', answers: ['Vorsitzender des Gemeinderates und Landtages sowie Stadtoberhaupt','Nur Leiter der Polizei','Nur Vorsitzender des Bundesrates','Nur Bezirksvorsteher'], correct: 0, source: 'Wien, 39-054' },
  { id: 552, category: 'Staatsbürgerschaft Wien', question: 'Welche politische Funktion üben Wiener Gemeinderätinnen und Gemeinderäte gleichzeitig noch aus?', answers: ['Landtagsabgeordnete des Wiener Landtags','Mitglieder des Nationalrates','Bezirksrichter','Mitglieder des Bundesrates'], correct: 0, source: 'Wien, 39-055' },
  { id: 553, category: 'Staatsbürgerschaft Wien', question: 'Welche Bezirke befinden sich nördlich der Donau?', answers: ['Floridsdorf und Donaustadt','Leopoldstadt und Brigittenau','Hietzing und Liesing','Favoriten und Simmering'], correct: 0, source: 'Wien, 39-056' },
  { id: 554, category: 'Staatsbürgerschaft Wien', question: 'Welche Bezirke befinden sich nördlich der Donau?', answers: ['Floridsdorf und Donaustadt','Leopoldstadt und Brigittenau','Währing und Döbling','Ottakring und Hernals'], correct: 0, source: 'Wien, 39-057' },
  { id: 555, category: 'Staatsbürgerschaft Wien', question: 'Wann lebte Erzherzogin Maria Theresia in Wien?', answers: ['1717 bis 1780','1683 bis 1740','1740 bis 1815','1804 bis 1867'], correct: 0, source: 'Wien, 39-058' },
  { id: 556, category: 'Staatsbürgerschaft Wien', question: 'Welches Open-Air Fest wird jährlich auf der Donauinsel gefeiert?', answers: ['Donauinselfest','Wiener Opernball','Donauwalzerfest','Rathausfestival'], correct: 0, source: 'Wien, 39-059' },
  { id: 557, category: 'Staatsbürgerschaft Wien', question: 'Was überreicht die Magistratsabteilung 11 (MA 11 - Amt für Jugend und Familie) anlässlich der Geburt eines Babys in Wien den Eltern?', answers: ['Ein Baby-Paket mit unter anderem Stoffwindelgutschein und Erstausstattungstasche','Einen Kinderreisepass','Eine Jahreskarte der Wiener Linien','Nur einen Geldbetrag'], correct: 0, source: 'Wien, 39-060' },
  { id: 558, category: 'Staatsbürgerschaft Wien', question: 'Auf Initiative welchen österreichischen Bundeskanzlers wurde Wien 1979 UNO-Sitz?', answers: ['Bruno Kreisky','Leopold Figl','Julius Raab','Franz Vranitzky'], correct: 0, source: 'Wien, 39-061' },
  { id: 559, category: 'Staatsbürgerschaft Wien', question: 'Welche internationalen Organisationen haben seit vielen Jahren ihren Sitz in Wien?', answers: ['Unter anderem UNO, IAEO, UNODC, UNIDO, OPEC und OSZE','Nur NATO und EU','Nur OECD und Europarat','Nur Weltbank und IWF'], correct: 0, source: 'Wien, 39-062' },
];
...
const localizeQuestion = (q:Question, language:string):Question | null => { if(language==='DE' || q.category.startsWith('Staatsbürgerschaft')) return q; const translated=QUESTION_TRANSLATIONS[language as QuestionLocale]?.[q.id]; return translated ? {...q,...translated} : null; };
...
const CategoryIcon = ({ category }: { category: string }) => {
  ...
  if (category.startsWith('Staatsbürgerschaft')) return <svg {...common}><path d="M6 4h12v16H6zM9 8h6M9 12h6M9 16h4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>;
...
function App() {
  ...
  const CATEGORY_LABELS: Record<string, Record<string,string>> = { DE:{Alle:'Alle',Allgemeinwissen:'Allgemeinwissen',Geografie:'Geografie',Wissenschaft:'Wissenschaft',Kultur:'Kultur',Geschichte:'Geschichte','Österreich':'Österreich',EU:'EU',Staatsbürgerschaft:'Staatsbürgerschaft','Staatsbürgerschaft Österreich':'Geschichte Österreichs','Staatsbürgerschaft Wien':'Wien',Islam:'Islam Fragen'}, EN:{Alle:'All',Allgemeinwissen:'General Knowledge',Geografie:'Geography',Wissenschaft:'Science',Kultur:'Culture',Geschichte:'History','Österreich':'Austria',EU:'EU',Staatsbürgerschaft:'Citizenship Questions','Staatsbürgerschaft Österreich':'History of Austria','Staatsbürgerschaft Wien':'Vienna',Islam:'Islam Questions'}, RU:{Alle:'Все',Geografie:'География',Wissenschaft:'Наука',Kultur:'Культура',Geschichte:'История','Österreich':'Австрия',EU:'ЕС',Islam:'Ислам'}, TR:{Alle:'Tümü',Geografie:'Coğrafya',Wissenschaft:'Bilim',Kultur:'Kültür',Geschichte:'Tarih','Österreich':'Avusturya',EU:'AB',Islam:'İslam'}, FR:{Alle:'Toutes',Geografie:'Géographie',Wissenschaft:'Sciences',Kultur:'Culture',Geschichte:'Histoire','Österreich':'Autriche',EU:'UE',Islam:'Islam'}, AR:{Alle:'الكل',Geografie:'الجغرافيا',Wissenschaft:'العلوم',Kultur:'الثقافة',Geschichte:'التاريخ','Österreich':'النمسا',EU:'الاتحاد الأوروبي',Islam:'الإسلام'}, BS:{Alle:'Sve',Geografie:'Geografija',Wissenschaft:'Nauka',Kultur:'Kultura',Geschichte:'Historija','Österreich':'Austrija',EU:'EU',Islam:'Islam'} };
      ...
      <main className={`shell appRoot gameHome font-${fontSize.toLowerCase()}`}>
        ...
        <section className="panel categoryPanel">
          ...
          <div className="categoryList">
            {citizenshipOpen ? (
              <>
                <button className="categoryRow citizenshipBack" onClick={() => setCitizenshipOpen(false)}>
                  <span className="categoryIcon">‹</span>
                  <span className="categoryName">{language === 'DE' ? 'Staatsbürgerschaft' : 'Citizenship Questions'}</span>
                  <span className="categoryCount">159</span>
                  <span className="categoryMark">⌃</span>
                </button>
                {CITIZENSHIP_TOPICS.map(item => {
                  const eligibleCount = QUESTIONS.filter(q => q.category === item).length;
                  const active = category === item;
                  return (
                    <button key={item} className={active ? 'categoryRow active citizenshipTopic' : 'categoryRow citizenshipTopic'} onClick={() => setCategory(item)} aria-pressed={active}>
              ...
              const isCitizenship = item === 'Staatsbürgerschaft';
              const eligibleCount = isCitizenship
                ? QUESTIONS.filter(q => q.category.startsWith('Staatsbürgerschaft')).length
                : QUESTIONS.filter(q => (item === 'Alle' || q.category === item) && (roundSize === 'max' || (difficulty === 'hard' ? HARD_QUESTION_IDS.has(q.id) : !HARD_QUESTION_IDS.has(q.id)))).length;
              const active = isCitizenship ? category.startsWith('Staatsbürgerschaft') : category === item;
              const handleClick = () => {
                if (isCitizenship) {
                  if (!category.startsWith('Staatsbürgerschaft')) setCategory('Staatsbürgerschaft Österreich');
                  setCitizenshipOpen(true);
                } else {
                  setCategory(item);
                }
              };
              return (
                <button key={item} className={active ? 'categoryRow active' : 'categoryRow'} onClick={handleClick} aria-pressed={active}>
                  <span className="categoryIcon"><CategoryIcon category={item} /></span>
                  <span className="categoryName">{categoryLabel(item)}</span>
                  <span className="categoryCount">{eligibleCount}</span>
                  <span className={active && !isCitizenship ? 'categoryMark selected' : 'categoryMark'}>{isCitizenship ? '›' : active ? '✓' : '›'}</span>
                </button>
              );
            })}
          </div>

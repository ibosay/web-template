...
Road revision: a solid dark asphalt surface, narrow glowing curb, moving lane marks and a contact shadow give the runner a clear surface under its feet. The old perspective grid below the ground line has been removed. The top curb is aligned to groundY, which is still the exact physics ground position. Graphics presets preserve this silhouette with a small fixed number of rectangles and no new particle emitters.

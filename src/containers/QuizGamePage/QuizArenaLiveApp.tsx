...
export const QUESTIONS: Question[] = [
  ...
  { id: 402, category: 'Staatsbürgerschaft', question: 'Wo lag das größte Konzentrationslager auf dem Gebiet des heutigen Österreich?', answers: ['Mauthausen','Dachau','Auschwitz','Buchenwald'], correct: 0, source: 'Geschichte Österreichs, 10-006' },
  { id: 403, category: 'Staatsbürgerschaft', question: 'Welches wichtige Ereignis geschah in Österreich 1955?', answers: ['Der Staatsvertrag wurde unterzeichnet','Österreich trat der EU bei','Die Republik wurde erstmals ausgerufen','Das Frauenwahlrecht wurde eingeführt'], correct: 0, source: 'Geschichte Österreichs, 10-008' },
  { id: 404, category: 'Staatsbürgerschaft', question: 'Welcher Fluss bildete in der Römerzeit eine wichtige Grenze des Römischen Reiches?', answers: ['Die Donau','Der Rhein','Die Elbe','Die Mur'], correct: 0, source: 'Geschichte Österreichs, 10-012' },
  ...
  { id: 406, category: 'Staatsbürgerschaft', question: 'Welche Familie begann ab 1273 lange Zeit über Österreich zu herrschen?', answers: ['Die Habsburger','Die Bourbonen','Die Hohenzollern','Die Medici'], correct: 0, source: 'Geschichte Österreichs, 10-017' },
  { id: 407, category: 'Staatsbürgerschaft', question: 'Zu welchem Reich gehörte Österreich bis zum Beginn des 19. Jahrhunderts?', answers: ['Zum Heiligen Römischen Reich','Zum Osmanischen Reich','Zum Russischen Reich','Zum Britischen Empire'], correct: 0, source: 'Geschichte Österreichs, 10-018' },
  { id: 408, category: 'Staatsbürgerschaft', question: 'In welchem Jahr wurde das Kaiserreich Österreich gegründet?', answers: ['1804','1789','1815','1867'], correct: 0, source: 'Geschichte Österreichs, 10-019' },
  ...
  { id: 410, category: 'Staatsbürgerschaft', question: 'Wie hieß Österreich in der ältesten genannten Urkunde?', answers: ['Ostarrîchi','Vindobona','Austria-Hungaria','Norikum'], correct: 0, source: 'Geschichte Österreichs, 10-026' },
  { id: 411, category: 'Staatsbürgerschaft', question: 'Wann wurde die Zweite Türkenbelagerung Wiens abgewehrt?', answers: ['1683','1529','1740','1815'], correct: 0, source: 'Geschichte Österreichs, 10-027' },
  { id: 412, category: 'Staatsbürgerschaft', question: 'Wie hieß die Zusammenkunft der Monarchen 1814 und 1815 in Wien?', answers: ['Wiener Kongress','Prager Kongress','Berliner Kongress','Salzburger Kongress'], correct: 0, source: 'Geschichte Österreichs, 10-029' },
  ...
  { id: 414, category: 'Staatsbürgerschaft', question: 'Welches Ereignis war der Auslöser des Ersten Weltkrieges?', answers: ['Die Ermordung Franz Ferdinands in Sarajevo','Die Unterzeichnung des Staatsvertrags','Die Gründung der UNO','Die Zweite Türkenbelagerung'], correct: 0, source: 'Geschichte Österreichs, 10-033' },
  { id: 415, category: 'Staatsbürgerschaft', question: 'Welche Staatsform erhielt Österreich 1918?', answers: ['Republik','Absolute Monarchie','Militärdiktatur','Königreich'], correct: 0, source: 'Geschichte Österreichs, 10-035' },
  { id: 416, category: 'Staatsbürgerschaft', question: 'Wann wurde die wiedererlangte Unabhängigkeit Österreichs erklärt?', answers: ['27. April 1945','15. Mai 1955','26. Oktober 1955','12. November 1918'], correct: 0, source: 'Geschichte Österreichs, 10-039' },
  ...
  { id: 418, category: 'Staatsbürgerschaft', question: 'Wer war der erste Bundespräsident der Zweiten Republik?', answers: ['Karl Renner','Theodor Körner','Leopold Figl','Adolf Schärf'], correct: 0, source: 'Geschichte Österreichs, 10-041' },
  { id: 419, category: 'Staatsbürgerschaft', question: 'Wer war der erste Bundeskanzler der Zweiten Republik?', answers: ['Leopold Figl','Karl Renner','Julius Raab','Theodor Körner'], correct: 0, source: 'Geschichte Österreichs, 10-042' },
  { id: 420, category: 'Staatsbürgerschaft', question: 'Seit wann ist Österreich Mitglied der UNO?', answers: ['Seit 1955','Seit 1945','Seit 1960','Seit 1995'], correct: 0, source: 'Geschichte Österreichs, 10-046' },
  ...
  { id: 422, category: 'Staatsbürgerschaft', question: 'Wann wurde der österreichische Staatsvertrag unterzeichnet?', answers: ['15. Mai 1955','26. Oktober 1955','27. April 1945','1. Jänner 1995'], correct: 0, source: 'Geschichte Österreichs, 10-052' },
  { id: 423, category: 'Staatsbürgerschaft', question: 'Wo wurde der österreichische Staatsvertrag unterzeichnet?', answers: ['Im Schloss Belvedere in Wien','In der Hofburg','Im Parlament','Im Schloss Schönbrunn'], correct: 0, source: 'Geschichte Österreichs, 10-053' },
  { id: 424, category: 'Staatsbürgerschaft', question: 'Wann wurde die immerwährende Neutralität Österreichs erklärt?', answers: ['26. Oktober 1955','15. Mai 1955','8. Mai 1945','1. Jänner 1995'], correct: 0, source: 'Geschichte Österreichs, 10-055' },
  ...
  { id: 426, category: 'Staatsbürgerschaft', question: 'Welches Wirtschaftssystem hat Österreich laut dem Fragenkatalog?', answers: ['Soziale Marktwirtschaft','Planwirtschaft','Reine Zentralverwaltungswirtschaft','Feudalwirtschaft'], correct: 0, source: 'Geschichte Österreichs, 10-058' },
  { id: 427, category: 'Staatsbürgerschaft', question: 'Wann entstand die Doppelmonarchie Österreich-Ungarn?', answers: ['1867','1804','1848','1918'], correct: 0, source: 'Geschichte Österreichs, 10-064' },
  { id: 428, category: 'Staatsbürgerschaft', question: 'Wann endete die Monarchie in Österreich?', answers: ['1918','1867','1938','1945'], correct: 0, source: 'Geschichte Österreichs, 10-068' },
  ...
  { id: 430, category: 'Staatsbürgerschaft', question: 'In welchem Jahr wurde der Name Österreich laut dem Fragenkatalog erstmals in einer Urkunde verwendet?', answers: ['996','1156','1273','1453'], correct: 0, source: 'Geschichte Österreichs, 10-097' },
...
export const HARD_QUESTION_IDS = new Set([411,414,416,417,418,419,421,422,423,424,22,25,26,27,37,42,46,48,51,52,53,54,57,58,59,63,65,68,69,70,72,73,77,80,83,86,87,88,113,115,121,126,127,128,133,134,135,136,137,140,141,142,143,144,145,146,147,148,149,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,227,228,229,230,231,232,233,234,235,236,237,238,239,240,241,242,243,244,245,246,247,248,249,250,333,334,341,342,346,352,353,354,358,360]);

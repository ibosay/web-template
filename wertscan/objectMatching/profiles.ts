...
const profiles: Record<FleaMarketCategory, CategoryProfile> = {
  ...
  art_antiques: {
    ...
    supportingFields: ['pattern', 'color', 'style', 'condition'],
    neverUseAsIdentity: ['serial'],
    exactMinScore: 0.94,
    comparableMinScore: 0.6,
  ...
  furniture_home: {
    ...
    exactAnyGroups: [
      { fields: ['manufacturer', 'modelNumber'], min: 2, observedRequired: true },
      { fields: ['brand', 'modelNumber'], min: 2, observedRequired: true },
      { fields: ['manufacturer', 'name', 'edition'], min: 3, observedRequired: true },
    ],
    comparableAnyGroups: [
      { fields: ['name', 'material', 'size', 'style', 'marking', 'year'], min: 3, observedRequired: true },
    ],
    strongFields: ['manufacturer', 'brand', 'modelNumber', 'name', 'material', 'size', 'style', 'marking'],
    supportingFields: ['shape', 'color', 'year', 'condition'],
    neverUseAsIdentity: ['serial'],
    exactMinScore: 0.9,
    comparableMinScore: 0.6,
    notes: ['Bei Möbeln ist ohne Hersteller Modellcode meist nur ein Vergleich über Typ, Material, Maße und Stil zulässig.'],
  },
  ...
  fashion_accessories: {
    ...
    exactMode: 'exact_product',
    exactAll: [{ field: 'brand', weight: 2, observedRequired: true }],
    exactAnyGroups: [{ fields: ['modelNumber', 'sku', 'model'], min: 1, observedRequired: true }],
    comparableAnyGroups: [
      { fields: ['brand', 'name', 'material', 'size', 'marking'], min: 3, observedRequired: true },
    ],
    strongFields: ['brand', 'modelNumber', 'sku', 'model', 'name', 'material', 'marking'],
    supportingFields: ['size', 'color', 'edition', 'condition'],
    neverUseAsIdentity: ['serial'],
    exactMinScore: 0.88,
    comparableMinScore: 0.62,
    notes: ['Bei Taschen, Schuhen und Kleidung sind Stylecode oder Modellcode stärker als Farbe oder bloße Ähnlichkeit.'],
  },
  ...
  music_instruments: {
    ...
    strongFields: ['brand', 'manufacturer', 'modelNumber', 'model', 'name', 'marking', 'year'],
    supportingFields: ['material', 'size', 'color', 'condition'],
    neverUseAsIdentity: ['serial'],
    exactMinScore: 0.9,
    comparableMinScore: 0.64,
    notes: ['Seriennummern werden nicht als Modellnummer behandelt. Marke und sichtbarer Modellcode haben Vorrang.'],
  },
  ...
  sports_outdoor: {
    ...
    exactAnyGroups: [{ fields: ['modelNumber', 'sku', 'model'], min: 1, observedRequired: true }],
    comparableAnyGroups: [
      { fields: ['brand', 'name', 'size', 'material', 'edition'], min: 3, observedRequired: true },
    ],
    strongFields: ['brand', 'modelNumber', 'sku', 'model', 'name', 'size'],
    supportingFields: ['material', 'color', 'edition', 'year', 'condition'],
    neverUseAsIdentity: ['serial'],
    exactMinScore: 0.88,
    comparableMinScore: 0.62,
    notes: ['Bei Sport und Outdoor Produkten muss eine Modellkennung vorliegen, sonst wird nur über mehrere passende Merkmale verglichen.'],
  },

...
export const QUESTIONS: Question[] = [
  ...
  { id: 341, category: 'Islam', question: "Welche Rechtsschule gehört zu den vier großen sunnitischen Madhahib?", answers: ["Schafiʿi","Jaʿfari","Ismaili","Zaydi"], correct: 0, source: "Shafi'i school overview; SeekersGuidance" },
  ...
  { id: 344, category: 'Islam', question: "Welche dieser Schulen gehört nicht zu den vier sunnitischen Rechtsschulen?", answers: ["Jaʿfari","Hanafi","Maliki","Hanbali"], correct: 0, source: "Oxford Bibliographies; SeekersGuidance, Four Sunni schools" },
  { id: 345, category: 'Islam', question: "Welche Antwort nennt alle vier großen sunnitischen Rechtsschulen?", answers: ["Hanafi, Maliki, Schafiʿi, Hanbali","Hanafi, Jaʿfari, Zaydi, Maliki","Maliki, Ismaili, Hanafi, Zaydi","Hanbali, Jaʿfari, Ismaili, Schafiʿi"], correct: 0, source: "SeekersGuidance, Four Sunni schools" },
